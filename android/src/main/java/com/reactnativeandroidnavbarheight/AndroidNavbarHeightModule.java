...
public class AndroidNavbarHeightModule extends ReactContextBaseJavaModule {
    ...
    public AndroidNavbarHeightModule(ReactApplicationContext reactContext) {
        super(reactContext);
    }
  ...
  @ReactMethod
  public void getNavigationBarHeight(Promise p) { p.resolve(getNavigationBarHeightSync()); }
}